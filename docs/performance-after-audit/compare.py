...
binaries = {'fxi': str(a.fxi.resolve()), 'fxi-packed': str(a.fxi.resolve()), 'tgrep': str(a.tgrep.resolve()),
...
result={'source_snapshot': str(a.snapshot), 'corpus': str(root), 'manifest_sha256': old['manifest_sha256'],
        ...
        'note':'fxi disables packed reads; fxi-packed enables existing source packs. Both reuse the same index; this is not an index-size/build comparison.',
...
for pattern in [row['pattern'] for row in old['rows']]:
