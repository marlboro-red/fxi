...
- [Query-local validation experiment](docs/performance-query-local/NOTES.md): checked dictionary pages and posting validation on demand, with explicit integrity semantics and standalone/resident CLI measurements.
- [Architecture follow-up measurements](docs/performance-architecture-next/NOTES.md): regex line routing, streamed compaction, publication costs and strict startup validation, with measured tradeoffs.
